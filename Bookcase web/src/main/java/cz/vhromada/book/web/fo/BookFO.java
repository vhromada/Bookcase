...
public class BookFO implements Serializable {
     ...
     * Languages
     */
    private @Size(min = 1) List<Language> languages;
     ...
     * Authors
     */
    private @Size(min = 1) List<Integer> authors;

    /**
     * Categories
     */
    private @Size(min = 1) List<Integer> categories;
     ...
     */
    public void setAuthors(final List<Integer> authors) {
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof BookFO) || id == null) {
            return false;
        }

        return id.equals(((BookFO) obj).id);
    }
    ...
    public String toString() {
        return String.format("BookFO [id=%d, czechName=%s, originalName=%s, languages=%s, isbn=%s, issueYear=%s, description=%s, electronic=%b, paper=%b, "
