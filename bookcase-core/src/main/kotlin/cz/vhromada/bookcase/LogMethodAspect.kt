...
class LogMethodAspect {
     ...
     */
    @Around("bookcaseFacadePointcut() || commonFacadePointcut()")
     ...
     */
    @Pointcut("execution(public * cz.vhromada.bookcase..*FacadeImpl.*(..))")
    @Suppress("unused")
    fun bookcaseFacadePointcut() {
        // pointcut
    }
