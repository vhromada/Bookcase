 ...
 * @return updated item
 */
fun com.github.vhromada.bookcase.domain.Item.updated(): com.github.vhromada.bookcase.domain.Item {
...
object ItemUtils {
     ...
     * @return item
     */
    fun newItemDomain(id: Int?): com.github.vhromada.bookcase.domain.Item {
        return com.github.vhromada.bookcase.domain.Item(id = id, languages = emptyList(), format = Format.TXT, note = null, position = if (id == null) null else id - 1, audit = null)
                .updated()
    }
     ...
     */
    fun getItems(book: Int): List<com.github.vhromada.bookcase.domain.Item> {
     ...
     */
    fun getItem(index: Int): com.github.vhromada.bookcase.domain.Item {
     ...
     */
    private fun getItem(bookIndex: Int, itemIndex: Int): com.github.vhromada.bookcase.domain.Item {
     ...
     * @return item
     */
    fun getItem(entityManager: EntityManager, id: Int): com.github.vhromada.bookcase.domain.Item? {
        return entityManager.find(com.github.vhromada.bookcase.domain.Item::class.java, id)
    }
     ...
     */
    fun assertItemsDeepEquals(expected: List<com.github.vhromada.bookcase.domain.Item?>?, actual: List<com.github.vhromada.bookcase.domain.Item?>?) {
        assertSoftly {
     ...
     */
    fun assertItemDeepEquals(expected: com.github.vhromada.bookcase.domain.Item?, actual: com.github.vhromada.bookcase.domain.Item?) {
        assertSoftly {
            it.assertThat(expected).isNotNull
            it.assertThat(actual).isNotNull
        }
     ...
     * @param actual   actual items
     */
    fun assertItemListDeepEquals(expected: List<Item?>?, actual: List<com.github.vhromada.bookcase.domain.Item?>?) {
        assertSoftly {
            it.assertThat(expected).isNotNull
            it.assertThat(actual).isNotNull
        }
     ...
     * @param actual   actual item
     */
    fun assertItemDeepEquals(expected: Item?, actual: com.github.vhromada.bookcase.domain.Item?) {
        assertSoftly {
            it.assertThat(expected).isNotNull
            it.assertThat(actual).isNotNull
        }
