...
/**
 * A class represents integration test for class [AuthorFacadeImpl].
 *
 * @author Vladimir Hromada
 */
@ContextConfiguration(classes = [CoreTestConfiguration::class])
class AuthorFacadeImplIntegrationTest : MovableParentFacadeIntegrationTest<Author, cz.vhromada.bookcase.domain.Author>() {
    ...
    override fun getDataList(): List<cz.vhromada.bookcase.domain.Author> {
        return AuthorUtils.getAuthors()
    }

    override fun getDomainData(index: Int): cz.vhromada.bookcase.domain.Author {
    ...
    override fun newDomainData(id: Int): cz.vhromada.bookcase.domain.Author {
        return AuthorUtils.newAuthorDomain(id)
    }

    override fun getRepositoryData(id: Int): cz.vhromada.bookcase.domain.Author? {
    ...
    override fun assertDataListDeepEquals(expected: List<Author>, actual: List<cz.vhromada.bookcase.domain.Author>) {
        AuthorUtils.assertAuthorListDeepEquals(expected, actual)
    }

    override fun assertDataDeepEquals(expected: Author, actual: cz.vhromada.bookcase.domain.Author) {
        AuthorUtils.assertAuthorDeepEquals(expected, actual)
    }

    override fun assertDataDomainDeepEquals(expected: cz.vhromada.bookcase.domain.Author, actual: cz.vhromada.bookcase.domain.Author) {
        AuthorUtils.assertAuthorDeepEquals(expected, actual)
    }
