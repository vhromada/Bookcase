...
VALUES (1, 'Author 1 First Name', '', 'Author 1 Last Name', 0);
INSERT INTO authors (id, first_name, middle_name, last_name, position)
VALUES (2, 'Author 2 First Name', 'Author 2 Middle Name', 'Author 2 Last Name', 1);
INSERT INTO authors (id, first_name, middle_name, last_name, position)
VALUES (3, 'Author 3 First Name', '', 'Author 3 Last Name', 2);

INSERT INTO books (id, czech_name, original_name, isbn, issue_year, description, note, position)
VALUES (1, 'Book 1 Czech Name', 'Book 1 Original Name', 'Book 1 ISBN', 2001, 'Book 1 Description', 'Book 1 Note', 0);
INSERT INTO books (id, czech_name, original_name, isbn, issue_year, description, note, position)
VALUES (2, 'Book 2 Czech Name', 'Book 2 Original Name', '', 2002, 'Book 2 Description', '', 1);
INSERT INTO books (id, czech_name, original_name, isbn, issue_year, description, note, position)
VALUES (3, 'Book 3 Czech Name', 'Book 3 Original Name', 'Book 3 ISBN', 2003, 'Book 3 Description', 'Book 3 Note', 2);

INSERT INTO items (id, book, format, note, position)
VALUES (1, 1, 'PAPER', 'Book 1 Item 1 Note', 0);
INSERT INTO items (id, book, format, note, position)
VALUES (2, 1, 'PDF', '', 1);
INSERT INTO items (id, book, format, note, position)
VALUES (3, 1, 'TXT', 'Book 1 Item 3 Note', 2);
INSERT INTO items (id, book, format, note, position)
VALUES (4, 2, 'PAPER', 'Book 2 Item 1 Note', 0);
INSERT INTO items (id, book, format, note, position)
VALUES (5, 2, 'PDF', '', 1);
INSERT INTO items (id, book, format, note, position)
VALUES (6, 2, 'TXT', 'Book 2 Item 3 Note', 2);
INSERT INTO items (id, book, format, note, position)
VALUES (7, 3, 'PAPER', 'Book 3 Item 1 Note', 0);
INSERT INTO items (id, book, format, note, position)
VALUES (8, 3, 'PDF', '', 1);
INSERT INTO items (id, book, format, note, position)
VALUES (9, 3, 'TXT', 'Book 3 Item 3 Note', 2);
