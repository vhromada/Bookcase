package com.github.vhromada.bookcase.web.validator.constraint

import com.github.vhromada.bookcase.web.validator.DateRangeValidator
...
annotation class DateRange(
         ...
         */
        val message: String = "{com.github.vhromada.bookcase.validator.DateRange.message}",
